...
# Innovate_Painter无限创意画布V1.3.36更新
 ...
 3. 增加UI组件动画过渡效果
 4. 增加自定义工作流加入画布的预览图功能
 5. 所有组件兼容图像和视频组件
 6. 支持拖拽视频进入画布
 7. 增加百度翻译组件和词汇处理组件
 8. win10、win11UI系统动画BUG修复

开发者提示:自定义工作流后可以增加的字段[al],[qn],[本地]，例如：SD1.5工作流[本地]，用这个方式命名工作流!!!
自定义工作流视频的参数字段：保存视频||Save Video，以这个节点保存视频，系统才能自动识别自定义视频工作流
...
<img width="1600" height="896" alt="image" src="https://github.com/user-attachments/assets/d9ddb7c7-7882-4fe5-a10a-bfd302497819" />
<img width="1600" height="896" alt="image" src="https://github.com/user-attachments/assets/2378384c-4ee5-49b2-be1f-c93ccdb781d5" />
...
# Innovate_Painter无限创意画布V1.3.15更新
  1. 修复工作流不加载图像显示名称BUG
  2. 增加图像管理扩展
  3. 增加文档管理扩展支持PDF、Text、MD文档等预览
  4. 增加首页预设：文档预览、图库管理、词库管理

## V1.3.15功能预览
<img width="1600" height="896" alt="image" src="https://github.com/user-attachments/assets/f7d4e5c1-c384-40a8-b104-f8e72481f0e5" />
<img width="1600" height="896" alt="image" src="https://github.com/user-attachments/assets/bad4fc8b-8439-474c-8563-63afc9ac1673" />
<img width="1600" height="896" alt="image" src="https://github.com/user-attachments/assets/0ec69ada-c79f-48db-b220-cdd235d546d7" />


# Innovate_Painter无限创意画布V1.1.12更新
...
<img width="1928" height="1048" alt="QQ截图20260817150203" src="https://github.com/user-attachments/assets/956b4756-787a-44bf-8543-d7bedf3df707" />
  ...
  2. 支持ComfyUI云端部署和本地部署方案，本地部署目前推荐使用自定义工作流，正式版将开放所有本地功能
  3. 支持ComfUI原生魔方绘图功能
  4. 支持Qwen-image、Klein9B、FLUXF.1、SDXL、SD1.5、一键抠图、水印去除、智能扩图、一键精修、超清修复、单图编辑、双图编辑、局部重绘等原生功能
  5. 支持历史管理和图片点评功能
  6. 支持历史记录一键拖拽进入无限画布和魔方创作
  7. 支持自定义提示词管理、增加、删除、修改
  8. 支持自定义提示词库的增加、删除、修改
  9. 支持自定义相册管理和查看等功能
  10. 支持deepseek智能助手插件功能
  11. 支持自定义背景修改、首页设置、画布动画设置
  12. 支持ComfyUI自定义工作流强大的原生态
  13. 支持无限画布批量文生图、图生图、批量执行工作流生态
  14. 支持图像在线编辑、调整、滤镜等使用
  15. 支持局部重绘
  16. 支持图像对比
  17. 支持AI语音生成
  18. 支持深色|浅色模式的功能切换
...
# 一、无限画布功能预览
<img width="1928" height="1048" alt="QQ截图20260817141748" src="https://github.com/user-attachments/assets/9c8f5094-174d-4136-b8c2-c50e95826e90" />
<img width="1928" height="1048" alt="QQ截图20260817142041" src="https://github.com/user-attachments/assets/0e4cb47d-97b8-4a20-9029-b6aeec972d1e" />

# 二、无限画布文生图功能预览
<img width="1928" height="1048" alt="QQ截图20260817142250" src="https://github.com/user-attachments/assets/c699e1d2-124b-4a2d-8b9a-055f96580179" />
<img width="1928" height="1048" alt="QQ截图20260817142517" src="https://github.com/user-attachments/assets/10ea6ce0-c10d-48a8-8dfc-11a0484a2530" />

# 三、无限画布智能助手功能预览
<img width="1928" height="1048" alt="QQ截图20260817143726" src="https://github.com/user-attachments/assets/d9914cc0-de38-462b-8373-b209e8fe7a4b" />
